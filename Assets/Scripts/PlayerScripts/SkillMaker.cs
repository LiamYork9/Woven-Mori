...
public class SkillMaker : MonoBehaviour
{
    ...
    public void SkillCreation()
    {
        ...
        Skill Flex = new Skill(SkillId.Flex, "Flex", Element.None, Target.self, Category.Buff, 0, 0, 1, "Get Ripped", 0, 1).Attr(new StatBoostConAttr(Stats.Attack, 10, true)).Attr(new StatBoostConAttr(Stats.Defence, 2));
        madeSkills.Add(Flex);
