...
public class SkillMaker : MonoBehaviour
{
    ...
    public void SkillCreation()
    {
        ...
        Skill SpeedUp = new Skill(SkillId.SpeedUp,"Speed Up",0,Element.None,Target.self,Category.Buff,100,1,"Boost your Priority",1,1).Attr(new PriorityAttr(2,3));
