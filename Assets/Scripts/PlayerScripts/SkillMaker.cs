...
public class SkillMaker : MonoBehaviour
{
    ...
    public void SkillCreation()
    {
        ...
        Skill Flex = new Skill(SkillId.Flex, "Flex", Element.None, Target.self, Category.Buff, 0, 0, 1, "Get Ripped", 0, 1).Attr(new StatBoostAttr(Stats.Attack, 10, false)).Attr(new StatBoostAttr(Stats.Defence, 2));
        madeSkills.Add(Flex);
